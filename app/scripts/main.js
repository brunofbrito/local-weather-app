...
*/
    ...
    function getLocationAndWeather(){
      ...
      */
        ...
        xhr.open("GET", "https://fourtonfish.com/tutorials/weather-web-app/getlocationandweather.php?owapikey=a6b740fb9e63934752b254bb07ca9a12&units=metric", true);
        xhr.send();
    ...
    function getWeatherForLocation(){
      ...
      if (location != null){
        ...
        xhr.open("GET", "https://fourtonfish.com/tutorials/weather-web-app/getweatherforlocation.php?owapikey=a6b740fb9e63934752b254bb07ca9a12&units=metric&location=" + location, true);
        xhr.send();
      }
      else{
        alert("Unable to fetch the location and weather data.");
    ...
    function loadBackground(lat, lon, weatherTag) {
      ...
      script_element.src = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=2274b5529885d4fc3d98d983bc0d5ece&lat=" + lat + "&lon=" + lon + "&accuracy=1&tags=" + weatherTag + "&sort=relevance&extras=url_l&format=json";
